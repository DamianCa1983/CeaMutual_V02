...
if ($errors) {
    ...
    $mailBody  = "Nuevo Mensaje desde la Pagina web - ARTICULOS PARA EL HOGAR" . PHP_EOL . PHP_EOL;
    $mailBody .= "Nombre del Producto: "."$nomProd". PHP_EOL.$company. PHP_EOL . PHP_EOL;
    $mailBody .= "Marca del Prodcuto: "."$marcaProd". PHP_EOL.$company. PHP_EOL . PHP_EOL;
    $mailBody .= "Modelo del Producto: "."$modProd". PHP_EOL.$company. PHP_EOL . PHP_EOL;
    $mailBody .= "Nombre: "."$nombre". PHP_EOL.$company. PHP_EOL . PHP_EOL;
    ...
    $mailBody .= "Mensaje: "."$mensaje". PHP_EOL.$company. PHP_EOL . PHP_EOL;
    ...
    if(mail("sec.general@cearg.org.ar", $subject, $mailBody, $headers)){
        echo '<div class="alert alert-success">Excelente! Su mensaje fue enviado correctamente.</div>';
    }
}
