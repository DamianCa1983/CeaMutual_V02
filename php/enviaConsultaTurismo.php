...
$destTur      = @$_POST["destTur"];
$paqTur      = @$_POST["paqTur"];
$hotelTur      = @$_POST["hotelTur"];
$nombre      = @$_POST["nombre"];
...
if ($errors) {
    ...
    $mailBody  = "Nuevo Mensaje desde la Pagina web - TURISMO" . PHP_EOL . PHP_EOL;
    $mailBody .= "Destino: "."$destTur". PHP_EOL.$company. PHP_EOL . PHP_EOL;
    $mailBody .= "Paquete: "."$paqTur ". PHP_EOL.$company. PHP_EOL . PHP_EOL;
    $mailBody .= "Hotel: "."$hotelTur". PHP_EOL.$company. PHP_EOL . PHP_EOL;
